    ...
    <section class="flex justify-center px-6">
      ...
      <form @submit.prevent="onSubmitForm" enctype="multipart/form-data">
        <div class="items-center justify-center text-center border-b">
          ...
          <div class="mb-3">
            <label for="profilePicture" class="text-blue-500" style="cursor: pointer"
              >프로필 사진 수정</label
            >
            <input
              type="file"
        ...
        <div>
          <div
            class="grid grid-cols-2 gap-1 py-2 border-b"
        ...
        <button type="submit" class="w-full bg-blue-500 text-white py-4 rounded-lg text-lg font-medium mt-4">완료</button>
      </form>
    </section>
  </div>
</template>
