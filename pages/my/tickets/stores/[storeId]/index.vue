  ...
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
    <div class="max-w-md mx-auto bg-white min-h-screen shadow-lg">
      <header class="bg-white p-4 flex items-center">
        <h1 class="text-3xl font-semibold text-center flex-1 text-gray-700">
          {{ storeInfo.storeName }}
        </h1>
      </header>
      ...
      <main class="p-6">
        <div
          class="bg-gradient-to-r from-emerald-400 to-teal-500 rounded-3xl p-6 mb-8 shadow-lg transform transition-transform duration-300 flex items-center justify-between"
        >
        ...
        <div class="flex items-center justify-center mb-8">
          ...
          <span class="mx-8 text-3xl font-semibold text-gray-800">{{
            ticketQuantity
          }}</span>
          <button
            class="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-gray-100 transition-colors duration-300"
    ...
    >
      <div
        class="bg-white rounded-3xl p-6 w-11/12 max-w-md transform transition-all duration-300"
        :class="{
