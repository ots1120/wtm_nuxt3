<template>
  <div
    v-if="props.ticket.ticketAmount > 0"
    class="flex items-start space-x-4 py-4 px-4 border-b border-gray-200"
  >
    <a
      class="flex space-x-4 flex-1 cursor-pointer"
    ...
    <div class="flex-shrink-0 pt-1">
      <BookmarkButton
        :is-bookmarked="ticket.isBookmarked"
