<template>
  <div class="w-full bg-white">
    <div class="flex justify-around border-b text-center text-sm w-full">
      <button
        class="flex flex-col items-center text-gray-700 hover:text-blue-500 focus:outline-none"
        @click="navigateToPath"
      >
        <svg class="w-6 h-6 mb-1" viewBox="0 0 24 24" fill="none">
